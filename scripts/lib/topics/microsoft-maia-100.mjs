...
const t = createAcceleratorTopic({
  ...
  productDescription: 'Azure Maia 100 AI accelerator — TSMC 5nm + CoWoS + HBM3e',
  volumeEstimate: 300_000,
  methodology: {
    edaRouting: 'Synopsys, Cadence, Siemens EDA, Ansys, Arm flow directly to product (design-time)',
    assemblyRouting: 'MSFT 10-K discloses contract manufacturers; Maia uses TSMC advanced packaging and HBM stacks',
  },
  tier1NodeMeta: {
    TSMC: TIER1_SNIPPETS.tsmc('MSFT 10-K / industry: foundry & CoWoS for Maia 100'),
  ...
  tier1Roles: {
    TSMC: { group: 'foundry', value: 188, note: 'Maia 100 compute die + CoWoS' },
    'SK Hynix': { group: 'memory', value: 198, note: 'HBM3e for Azure AI clusters' },
