...
export const TOPIC_ID = 'nvidia-h200';

export const H200_ANNUAL_VOLUME_ESTIMATE = 1_500_000;

export const NODE_META = {
  'Nvidia H200': { tier: TIERS.product, group: 'product', description: 'Blackwell B200/H200 SXM — 141GB HBM3e' },

  // Tier 1
  TSMC: { tier: TIERS.tier1, group: 'foundry', description: 'NVDA 10-K: primary foundry; CoWoS-S packaging' },
  Samsung: { tier: TIERS.tier1, group: 'memory', description: 'NVDA 10-K: foundry + HBM3e memory supplier' },
  'SK Hynix': { tier: TIERS.tier1, group: 'memory', description: 'NVDA 10-K: primary HBM3e supplier' },
  Micron: { tier: TIERS.tier1, group: 'memory', description: 'NVDA 10-K: HBM3e memory supplier' },
  'Hon Hai (Foxconn)': { tier: TIERS.tier1, group: 'osat', description: 'NVDA 10-K: assembly, test & packaging subcontractor' },
  Wistron: { tier: TIERS.tier1, group: 'osat', description: 'NVDA 10-K: assembly, test & packaging subcontractor' },
  Fabrinet: { tier: TIERS.tier1, group: 'osat', description: 'NVDA 10-K: assembly, test & packaging subcontractor' },
  'ASE Technology': { tier: TIERS.tier1, group: 'osat', description: 'OSAT — cited across TSM, SNPS, CDNS, MU filings' },
  ...
  Ibiden: { tier: TIERS.tier2, group: 'materials', description: 'ABF substrates for CoWoS interposer' },
  ...
  // Tier 4 — raw materials & upstream inputs into Tier 3
  ...
  // Tier 5 — bulk / extractive upstream into Tier 4
...
export const PRODUCT_NODE = 'Nvidia H200';

export const METHODOLOGY = {
  edaRouting: 'Synopsys, Cadence, Siemens EDA, Ansys, Arm flow directly to product (design-time)',
  assemblyRouting: 'Hon Hai, Wistron, Fabrinet disclosed as NVDA 10-K assembly subcontractors',
};

export const SEC_SUPPLY_ROLES = {
  TSMC: { tier: 1, group: 'foundry', targets: [PRODUCT_NODE], value: 228, note: 'NVDA 10-K: primary foundry + CoWoS packaging' },
  Samsung: { tier: 1, group: 'memory', targets: [PRODUCT_NODE], value: 28, note: 'NVDA 10-K: alternate foundry + HBM supplier' },
  'SK Hynix': { tier: 1, group: 'memory', targets: [PRODUCT_NODE], value: 232 },
  Micron: { tier: 1, group: 'memory', targets: [PRODUCT_NODE], value: 18 },
  'Hon Hai (Foxconn)': { tier: 1, group: 'osat', targets: [PRODUCT_NODE], value: 12, note: 'NVDA 10-K: assembly subcontractor' },
  Wistron: { tier: 1, group: 'osat', targets: [PRODUCT_NODE], value: 10, note: 'NVDA 10-K: assembly subcontractor' },
  Fabrinet: { tier: 1, group: 'osat', targets: [PRODUCT_NODE], value: 8, note: 'NVDA 10-K: assembly subcontractor' },
  ...
  'ASE Technology': { tier: 1, group: 'osat', targets: ['TSMC'], value: 6 },
  ASML: { tier: 2, group: 'equipment', targets: ['TSMC', 'SK Hynix', 'Samsung', 'Micron'] },
  'Applied Materials': { tier: 2, group: 'equipment', targets: ['TSMC', 'SK Hynix', 'Samsung', 'Micron'] },
  'Lam Research': { tier: 2, group: 'equipment', targets: ['TSMC', 'SK Hynix', 'Samsung', 'Micron'] },
  KLA: { tier: 2, group: 'equipment', targets: ['TSMC', 'SK Hynix', 'Samsung', 'Micron'] },
  ...
  // Tier 5
  'SGL Carbon': { tier: 5, group: 'commodity', targets: ['IPG Photonics'], value: 3, note: 'Graphite for fiber laser diodes' },
  'Morgan Advanced Materials': { tier: 5, group: 'commodity', targets: ['Ferrotec'], value: 2, note: 'Ceramic powders for chuck components' },
  Materion: { tier: 5, group: 'commodity', targets: ['Schott'], value: 2, note: 'Beryllium & specialty metals for EUV glass' },
  Sibelco: { tier: 5, group: 'commodity', targets: ['Corning'], value: 2, note: 'High-purity quartz for fused silica' },
  'Sumitomo Metal Mining': { tier: 5, group: 'commodity', targets: ['Hoya'], value: 2, note: 'Optical-grade metal precursors' },
};

export const MATERIALS_ALLOWLIST = ['Trumpf', 'TOTO', 'JSR', 'Shin-Etsu (PR)', 'Shin-Etsu (Wafers)', 'Linde', 'Ibiden', 'Schott', 'Hoya', 'Corning', 'Pfeiffer Vacuum', 'Ferrotec', 'IPG Photonics', 'SGL Carbon', 'Morgan Advanced Materials', 'Materion', 'Sibelco', 'Sumitomo Metal Mining'];
